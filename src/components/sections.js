  ...
  <div class="appointment-modal" id="appointment-modal" hidden aria-hidden="true">
    ...
    <div class="appointment-modal__dialog" role="dialog" aria-modal="true" aria-label="Book an Appointment">
      ...
      <div class="appointment-modal__header">
        ...
        <p>Reserve your preferred time at ${data.name}, Satna.</p>
      </div>
  ...
  <header class="site-header" id="home">
    ...
    <section class="hero section-shell">
      <div class="hero__content reveal reveal--fast">
        <p class="eyebrow">${data.name} • ${data.category}</p>
        <h1>${data.tagline}</h1>
      ...
      <div class="hero__visual reveal">
        <div class="hero-card hero-card--image">
          <img
            ...
            alt="${data.name} interior in Satna"
            fetchpriority="high"
          />
  ...
  <main id="main-content" class="page-content">
    ...
    <section class="section-shell section-grid" style="padding-top: 5rem;">
      <div class="section-copy reveal">
        <p class="eyebrow">Welcome to ${data.name}</p>
        <h2>Beauty Care With a Personal Touch</h2>
        <p>
          Located at Navrang Park Colony in Satna, ${data.name} provides a refined, hygienic, and welcoming salon experience — offering expert haircuts, blow drys, bridal makeup, facials, spa services, and complete grooming.
        </p>
        <p>
          Our team focuses on personalized consultations, top-tier L'Oréal Professionnel products, and high standards of cleanliness to ensure every visit leaves you looking your best and feeling confident.
        </p>
    ...
    <section class="section-shell cta-section" style="padding-bottom: 5rem;">
      <article class="cta-card reveal">
        ...
        <div class="cta-actions">
          <a class="button button--primary" href="#contact">Book Appointment</a>
          <a class="button button--secondary" href="tel:${data.phone}" aria-label="Call ${data.name} at ${data.contactCtaLabel}">
            Call Now
          </a>
        </div>
      </article>
...
const renderAboutPage = (data) => `
  ${renderSubpageHeader(
    ...
    `Discover ${data.name} — Satna's premier L'Oréal Professionnel unisex salon offering expert haircuts, bridal makeup, skin care, spa services, and complete grooming.`,
    data,
    "about"
  )}
  <main id="main-content" class="page-content">
    <section class="section-shell section-grid" style="padding-top: 1rem;">
      <div class="section-copy reveal">
        ...
        <h2>A Premier Unisex Salon in Satna</h2>
        <p>
          ${data.name} is a top-rated unisex salon in
          ${data.city}, ${data.state}. Our salon is built around professional hair styling, expert bridal & makeup services, spa wellness, and complete customer satisfaction.
        </p>
        <p>
    ...
    <section class="section-shell why-us" style="padding-top: 4rem;">
      <div class="section-head reveal" style="padding-top: 0;">
        ...
        <h2>Why Clients Trust ${data.name}</h2>
      </div>
      <div class="benefits-grid">
        ${data.whyChooseUs
          .map(
...
const renderServicesPage = (data) => `
  ${renderSubpageHeader(
    "Service Menu",
    "Our Salon Services",
    "Explore our professional haircuts, blow dry, extensions, bridal services, facials, spa treatments, waxing, tanning, pedicure, manicure, and grooming.",
    data,
    "services"
  )}
  <main id="main-content" class="page-content">
      ...
      <div class="contact-layout">
        <aside class="contact-panel reveal">
          ...
          <article class="contact-card">
            ...
            <div class="contact-card__body">
              <h3>Contact</h3>
              <a class="text-link text-link--bold" href="tel:${data.phone}" aria-label="Call ${data.name} at ${data.contactCtaLabel}">${data.contactCtaLabel}</a>
            </div>
          </article>
        </aside>
