export const salonData = {
      ...
      items: [
        {
          ...
          description: "Deep-cleansing skincare treatments designed to restore natural glow.",
          status: "verified"
        },
        {
          name: "Precision Threading",
          description: "Clean, defined brow shaping and gentle facial hair removal.",
          status: "verified"
        },
        {
          name: "Smooth Waxing",
          description: "Hygienic body waxing services for smooth, soft skin.",
          status: "verified"
        }
      ]
    },
  ...
  featuredServices: [
    ...
    {
      title: "Skin Radiance & Facials",
      description:
        "Restorative facial care, gentle threading, and skincare packages designed for healthy, glowing skin.",
      image:
        "https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=1200&q=80",
      alt: "Beauty and skincare treatment setup",
